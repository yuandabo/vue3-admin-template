...
const getHeight = (multipleTableRef, value, el) => {
...
const addTableHeightListener = (multipleTableRef, value, el) => {
  window.addEventListener('resize', debounce(getHeight.bind(null, multipleTableRef, value, el), 200))
}
const removeTableHeightListener = (multipleTableRef, value, el) => {
  window.removeEventListener('resize', debounce(getHeight.bind(null, multipleTableRef, value, el), 200))
}
